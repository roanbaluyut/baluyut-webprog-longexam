      ...
      <div className="flex w-full flex-col gap-6">
        <section className="border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <h1 className="text-4xl sm:text-5xl font-bold leading-tight text-zinc-900">Product not found</h1>
    ...
    <div className="flex w-full flex-col gap-6">
      ...
      <section className="border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h1 className="text-3xl text-4xl sm:text-5xl font-bold leading-tight text-zinc-900">
            {product.title}
          </h1>
        ...
        <div className="mx-auto max-w-3xl">
          <div>
            <img 
              src={product.image} 
              alt={product.title} 
              className="mx-auto flex min-h-120 items-center justify-center rounded-[1.25rem] bg-zinc-200 object-contain" 
            />
          </div>
